...
- Persisted prefs (volumes, sound, duration, target settings, gesture toggles, music folder/cutoff/invert/shuffle, binaural preset/carrier/beat): `lib/src/settings.dart` (`Settings`, SharedPreferences).
