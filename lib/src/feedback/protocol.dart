...
class ProtocolInfo {
  ...
  static const ProtocolInfo _alphaTheta = ProtocolInfo(
    ...
    guideText:
        ...
        '- Target Bands: Alpha (8–12 Hz) and Theta (4–8 Hz) on the frontal '
        'electrodes (AF7/AF8).\n'
  ...
  static const ProtocolInfo _drowsiness = ProtocolInfo(
    ...
    subtitle:
        ...
        'on-device AI layer (LUNA/REVE) that watches a 4-second window of raw '
        'EEG each second for the signatures of actually falling asleep, and '
        'plays a soft warning chime when you drift — so the rest stays awake.',
    guideText:
        'What to Meditate On\n'
        ...
        'embeds a 1024-sample, ~4-second EEG window at 256 Hz, once per '
        'second. During calibration it records an eyes-open "clear" anchor '
        'and an eyes-closed rest distribution. During the session a warning '
        'fires when the live sleep-direction measure is above the session '
        'warning threshold (default: 75th percentile of your eyes-closed rest '
        'baseline) or the frontal delta is above a ceiling. The model is a '
        'statistical estimate, not a medical device — false alarms are '
        'possible.\n'
        '\n'
        'Target Meditation Styles\n'
    ...
    algorithmDescription:
        ...
        'sleep guardrail: a per-second model score over a 4 s, 1024-sample '
        'EEG window. During calibration it captures an eyes-open "V_clear" '
        'anchor and a rest (eyes-closed) sleep-direction distribution. During '
