...
| [TODO/handoff-monitor.md](TODO/handoff-monitor.md) | Monitor series: **PR 5b next** (crash recovery + sqlite `kind`), then 6, **7** Bands context strip, **8** Spectrogram FFT window |
