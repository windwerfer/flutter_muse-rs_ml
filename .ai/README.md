...
| [archive/handoff-monitor-perf.md](archive/handoff-monitor-perf.md) | **In progress.** Graph draw-path perf PRs 1–7. Start: [handoff-monitor-perf-5.md](archive/handoff-monitor-perf-5.md). |
