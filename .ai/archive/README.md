...
Finished threads and historical notes. Not current orientation — see
[../README.md](../README.md).

| File | What it was |
|------|-------------|
| `handoff-monitor.md` | Monitor series map (PRs 0–7). **Complete.** PR 8 cancelled. Live spec: [../monitor.md](../monitor.md). |
...
| `handoff-soloud-engine.md` | SoLoud engine lifetime / loads / leftover muffle. Landed on `fix/soloud-engine-hardening`. Spec remains [../audio-engine.md](../audio-engine.md). |
